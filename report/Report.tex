...
Após analisar o problema, foi decidido que o projeto está dividido em dois executáveis, o \texttt{generator} e o \texttt{engine}. Para além destes, temos também na nossa arquitetura uma biblioteca comum aos dois, \texttt{common}, e as nossas dependencias em \texttt{dependencies}.
...
A nossa única dependência é o rapidxml (\url{http://rapidxml.sourceforge.net/manual.html}). Este permite-nos fazer rapidamente a interpretação do ficheiro de configuração onde estão definidos os objectos a desenhar.
...
Conseguimos que todas as primitivas fossem geradas corretamente e o motor gráfico é capaz de as representar genericamente.
